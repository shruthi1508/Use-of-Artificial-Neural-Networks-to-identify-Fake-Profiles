...
def importdata(): 
    balance_data = pd.read_csv('D:/shruthi/Summer_Project/Use of Artificial Neural Networks to Identify FakeProfiles/Profile/dataset/dataset.txt')
...
def UserCheck(request):
    if request.method == 'POST':
      ...
      input+=data+"\n"
      f = open("D:/shruthi/Summer_Project/Use of Artificial Neural Networks to Identify FakeProfiles/Profile/dataset/test.txt", "w")
      f.write(input)
      f.close()
      test = pd.read_csv('D:/shruthi/Summer_Project/Use of Artificial Neural Networks to Identify FakeProfiles/Profile/dataset/test.txt')
...
def ViewTrain(request):
    if request.method == 'GET':
       ...
       data = pd.read_csv('D:/shruthi/Summer_Project/Use of Artificial Neural Networks to Identify FakeProfiles/Profile/dataset/dataset.txt')
